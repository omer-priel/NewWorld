...
namespace NewWorld::Graphics
{
	...
	public:
		...
		static void DrawLine(int x1, int y1, int x2, int y2, const Graphics::Color& color, uint width = 1);
	...
	private:
		...
		static void DrawLine(RawPointer<Editor::EditorWindow> window, int x1, int y1, int x2, int y2, const Graphics::Color& color, uint width);
