...
namespace NewWorld::Editor::Components
{
	...
	protected:
		...
		// Getters
	public:
		virtual inline RawPointer<EditorWindow> GetWindow() const override { return m_Window; }

		virtual inline float GetX() const override { return m_X; }
		virtual inline float GetY() const override { return m_Y; }

		virtual inline bool IsIn(float x, float y) const override
		{
		...
		// Setters
	public:
		virtual void SetWindow(RawPointer<EditorWindow> window) override
		{
			m_Window = window;
		}
